...
WebUI.setEncryptedText(findTestObject('Object Repository/Page_Facebook  log in or sign up/input_Facebook helps you connect and share _ab63fc'), 
    'FfwV0VCa/EntiweHrIOd4Q==')

WebUI.delay(1)

WebUI.click(findTestObject('Page_Facebook  log in or sign up/button_Log in'))

WebUI.verifyElementText(findTestObject('Object Repository/Page_(20) Facebook/span_Simpan info login Anda ke Facebook'), 
    'Simpan info login Anda ke Facebook?')

WebUI.click(findTestObject('Object Repository/Page_(20) Facebook/span_Lain Kali'))

WebUI.verifyElementPresent(findTestObject('Object Repository/Page_(20) Facebook/path'), 0)
